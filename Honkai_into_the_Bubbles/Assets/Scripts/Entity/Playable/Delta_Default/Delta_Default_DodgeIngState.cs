...
public class Delta_Default_DodgeIngState : Playable_State
{
    private float speed;
    private int moveCount;
    private Delta_Default player;
    public Delta_Default_DodgeIngState(Playable _playerBase, Playable_StateMachine _stateMachine, string _animBoolName, Delta_Default _player) : base(_player, _stateMachine, _animBoolName)
    {
        this.player = _player;
    }
