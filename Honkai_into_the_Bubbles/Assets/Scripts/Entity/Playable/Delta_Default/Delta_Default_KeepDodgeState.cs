...
public class Delta_Default_KeepDodgeState : Playable_State
{
    private float speed;
    private int moveCount;
    private Delta_Default player;
    public Delta_Default_KeepDodgeState(Playable _playerBase, Playable_StateMachine _stateMachine, string _animBoolName, Delta_Default _player) : base(_playerBase, _stateMachine, _animBoolName)
    {
        this.player = _player;
    }
