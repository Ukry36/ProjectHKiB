...
public class Delta_L_DodgeEnterState : Delta_L_State
{
    public Delta_L_DodgeEnterState(Delta_L _player, Delta_L_StateMachine _stateMachine, string _animBoolName) : base(_player, _stateMachine, _animBoolName)
    {
