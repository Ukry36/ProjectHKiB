...
public class Delta_R_DodgeEnterState : Playable_State
{
    private Delta_R player;
    public Delta_R_DodgeEnterState(Playable _playerBase, Playable_StateMachine _stateMachine, string _animBoolName, Delta_R _player) : base(_playerBase, _stateMachine, _animBoolName)
    {
        this.player = _player;
    }
