...
public class Delta_R_BasicAttackExitState : Playable_State
{
    public int combo = 0;
    public bool attackReserved = false;
    private Delta_R player;
    public Delta_R_BasicAttackExitState(Playable _playerBase, Playable_StateMachine _stateMachine, string _animBoolName, Delta_R _player) : base(_playerBase, _stateMachine, _animBoolName)
    {
        this.player = _player;
    }
