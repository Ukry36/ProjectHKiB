...
public class Delta_R_BasicAttackExitState : Delta_R_State
{
    public int combo = 0;
    public bool attackReserved = false;
    public Delta_R_BasicAttackExitState(Delta_R _player, Delta_R_StateMachine _stateMachine, string _animBoolName) : base(_player, _stateMachine, _animBoolName)
    {
