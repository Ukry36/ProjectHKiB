...
public class Delta_Delta_DodgeEnterState : Playable_State
{
    private Delta_Delta player;
    public Delta_Delta_DodgeEnterState(Playable _playerBase, Playable_StateMachine _stateMachine, string _animBoolName, Delta_Delta _player) : base(_playerBase, _stateMachine, _animBoolName)
    {
        this.player = _player;
    }
