...
public class Delta_Delta_GraffitiIngState : Delta_Delta_State
{
    private Vector3 graffitiSavedInput;
    public Delta_Delta_GraffitiIngState(Delta_Delta _player, Delta_Delta_StateMachine _stateMachine, string _animBoolName) : base(_player, _stateMachine, _animBoolName)
    {
