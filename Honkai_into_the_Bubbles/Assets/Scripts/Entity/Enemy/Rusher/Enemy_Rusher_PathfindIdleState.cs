...
public class Enemy_Rusher_PathfindIdleState : Enemy_State
{
    private Collider2D[] colliders;

    private Enemy_Rusher enemy;
    public Enemy_Rusher_PathfindIdleState(Enemy _enemyBase, Enemy_StateMachine _stateMachine, string _animBoolName, Enemy_Rusher _enemy) : base(_enemyBase, _stateMachine, _animBoolName)
    {
        this.enemy = _enemy;
    }
