...
public class Enemy_Rusher_PathfindIdleState : Enemy_Rusher_State
{
    private Collider2D[] colliders;
    public Enemy_Rusher_PathfindIdleState(Enemy_Rusher _enemy, Enemy_Rusher_StateMachine _stateMachine, string _animBoolName) : base(_enemy, _stateMachine, _animBoolName)
    {
