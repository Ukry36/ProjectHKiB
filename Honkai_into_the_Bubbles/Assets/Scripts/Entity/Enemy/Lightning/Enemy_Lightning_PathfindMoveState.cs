...
public class Enemy_Lightning_PathfindMoveState : Enemy_State
{
    private StrictMoveNode SMN;

    private Enemy_Lightning enemy;
    public Enemy_Lightning_PathfindMoveState(Enemy _enemyBase, Enemy_StateMachine _stateMachine, string _animBoolName, Enemy_Lightning _enemy) : base(_enemyBase, _stateMachine, _animBoolName)
    {
        this.enemy = _enemy;
    }
