...
public class Enemy_Spider_RandomIdleState : Enemy_State
{
    private Collider2D[] colliders;

    private Enemy_Spider enemy;
    public Enemy_Spider_RandomIdleState(Enemy _enemyBase, Enemy_StateMachine _stateMachine, string _animBoolName, Enemy_Spider _enemy) : base(_enemyBase, _stateMachine, _animBoolName)
    {
        this.enemy = _enemy;
    }
