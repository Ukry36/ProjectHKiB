...
public class Enemy_Spider_RandomIdleState : Enemy_Spider_State
{
    private Collider2D[] colliders;
    public Enemy_Spider_RandomIdleState(Enemy_Spider _enemy, Enemy_Spider_StateMachine _stateMachine, string _animBoolName) : base(_enemy, _stateMachine, _animBoolName)
    {
