...
public class Enemy_Collapse_DirMoveState : Enemy_Collapse_State
{
    private int movementMultiplyer = 1;
    private StrictMoveNode SMN;
    public Enemy_Collapse_DirMoveState(Enemy_Collapse _enemy, Enemy_Collapse_StateMachine _stateMachine, string _animBoolName) : base(_enemy, _stateMachine, _animBoolName)
    {
