...
public class Enemy_Collapse_PathfindIdleState : Enemy_State
{
    private Collider2D[] colliders;

    private Enemy_Collapse enemy;
    public Enemy_Collapse_PathfindIdleState(Enemy _enemyBase, Enemy_StateMachine _stateMachine, string _animBoolName, Enemy_Collapse _enemy) : base(_enemyBase, _stateMachine, _animBoolName)
    {
        this.enemy = _enemy;
    }
