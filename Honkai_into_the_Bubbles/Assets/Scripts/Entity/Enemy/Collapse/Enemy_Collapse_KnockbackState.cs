...
public class Enemy_Collapse_KnockbackState : Enemy_State
{
    public Vector2 dir;
    public int coeff;
    private int i;
    ...
    public Enemy_Collapse_KnockbackState(Enemy _enemyBase, Enemy_StateMachine _stateMachine, string _animBoolName, Enemy_Collapse _enemy) : base(_enemyBase, _stateMachine, _animBoolName)
    {
        this.enemy = _enemy;
    }
