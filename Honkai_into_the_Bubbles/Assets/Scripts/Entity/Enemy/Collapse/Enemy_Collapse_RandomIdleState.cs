...
public class Enemy_Collapse_RandomIdleState : Enemy_Collapse_State
{
    private Collider2D[] colliders;
    public Enemy_Collapse_RandomIdleState(Enemy_Collapse _enemy, Enemy_Collapse_StateMachine _stateMachine, string _animBoolName) : base(_enemy, _stateMachine, _animBoolName)
    {
